...
import { Package, Clock, CheckCircle2, ShoppingBag, ArrowRight, MessageSquare } from "lucide-react";
            ...
            {loading ? (
                ...
                <div className="space-y-4">
                    {orders.map((order) => {
                        ...
                        return (
                            <div key={order.id} className="app-card border-none bg-white p-0 overflow-hidden">
                                <div className="p-6">
                                ...
                                <div className="bg-slate-50 p-3 flex justify-center text-[var(--primary)]">
                                    <button className="text-[10px] font-black uppercase tracking-widest flex items-center gap-1">
